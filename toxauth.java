...
class api {
    ...
    private String api_endpoint = "https://toxauth.me/api/v1/";

    private String user_agent = "Mozilla ToxAuth";
}
...
class messagebox {
    ...
    public static void show(String text, icons ico){
        JOptionPane.showMessageDialog(null, text, "ToxAuth", ico.selected_icon);
    }
}
